...
roverArea = (0.650+maxDiameter)*(0.650); %area profile of rover, 650mm x 650mm, converted to [m^2]
distance = 350; %distance to target [m]
travelArea = roverArea * distance; %total area profile of rover's path
