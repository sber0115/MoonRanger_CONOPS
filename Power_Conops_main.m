...
if (enable_craters)
    %up to 100 shadows are "seen" at random times as long as rover isn't
...
for i = length(trek_phase1)+1:length(time_vector)
    ...
    %curr_solar_offset is the factor by which max power is multiplied (< 1)
    ...
    if (rock_found && can_avoid_rock)    
        ...
        curr_load_in = (extreme_rove(2)*curr_solar_offset/3600);    %[Wh/s]      
